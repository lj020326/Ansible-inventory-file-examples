...
The yaml inventory implementing this hierarchy can be found in [hosts.ex5.yml](./hosts.ex5.yml):
...
The ini inventory implementing this hierarchy can be found in [hosts.ex5.ini](./hosts.ex5.ini):
